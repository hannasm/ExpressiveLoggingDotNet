...
{
    [TestClass]
    public class StdoutLogStreamAutoExecutorTests : SimpleAutoExecutorBase
    {
        public override ILogStream ConstructLoggger()
        {
            return new StdoutLogStream();
        }
    ...
    [TestClass]
    public class StderrLogStreamAutoExecutorTests : SimpleAutoExecutorBase
    {
        public override ILogStream ConstructLoggger()
        {
            return new StderrLogStream();
        }
