...
{
    [TestClass]
    public class DebugLogStreamAutoExecutorTests : SimpleAutoExecutorBase
    {
    ...
    [TestClass]
    public class TraceLogStreamAutoExecutorTests : SimpleAutoExecutorBase
    {
        public override ILogStream ConstructLoggger()
        {
            return new TraceLogStream();
        }
